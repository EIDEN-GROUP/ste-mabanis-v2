      ...
      <Section>
        <div className="columns-1 gap-8 md:columns-2 xl:columns-3">
          {testimonials.map((t, i) => (
            <Reveal key={t.name} delay={i * 60} className="mb-8 break-inside-avoid bg-card p-8 shadow-card">
        ...
        <Reveal className="mt-16 bg-navy p-10 text-center text-white sm:p-16">
          <h2 className="display text-[clamp(1.9rem,4vw,3rem)]">
            Le prochain témoignage sera peut-être le vôtre.
          </h2>
          <Link
            to="/contact"
